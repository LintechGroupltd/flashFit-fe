    ...
    <div className="w-full ">
      {customerReviewData.map((review) => (
       ...
       {/* left image section  */}
          <div className="mt-3  w-full h-full">
            <Image src={review.customerImg} alt="Customer" className=""/>
          </div>
      ...
      {/* right section */}
        <div className="md:mt-0 mt-3">
         ...
         <p className="mt-[5px] mb-2 md:text-[33px] text-[24px] font-sans italic font-[500]  md:leading-[45px] leading-[40px] text-[#101828]">{review.title}</p>
        ...
        <div className="py-2">
         ...
         <div className="flex gap-4">
          <div className="bg-[#D7D7D7] hover:bg-[#F8AD39] w-[54px] h-[54px] rounded-full">
            <Image src={review.leftArrow} alt="Left Arrow"  className="md:w-[24px] w-[50px] md:h-[55px] h-[24px] md:mt-0 mt-[14px] mx-auto"/>
          </div> 
