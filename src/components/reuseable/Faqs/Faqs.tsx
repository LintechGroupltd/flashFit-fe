    ...
    <div className="md:py-10 mt-14">
      <div className="grid md:grid-cols-12">
        <div className="col-span-5 " data-aos="fade-right">
          <h2 className="md:text-[48px] text-[35px] font-serif font-[600]">
            FAQs
          </h2>
          <p className="text-[18px] md:block hidden mt-2 font-sans font-[400]">
            Discover Everything You Need to Know About
            <br /> Servicing: Unveiling the Most Commonly Asked
            <br /> Questions (FAQs) with Detailed Answers
          </p>
          <p className="md:text-[18px] text-[16px] mt-2 md:hidden block font-sans font-[400]">
            Discover Everything You Need to Know About Servicing: Unveiling the
            Most Commonly Asked Questions (FAQs) with Detailed Answers
          </p>
        </div>
        ...
        <div className="md:mt-9 mt-7 col-span-7" data-aos="fade-left">
          <div>
            {FaqData.map(({ id, title, content }) => (
              <div key={id} className={`   md:px-5 px-2 bg-[#fff]`}>
                ...
                {openAccordionId === id && (
                  <p className="mt-3  text-justify md:text-[15px] text-[15px] font-sans font-[400] text-[#505050]">
                    {content}
                  </p>
                )}
