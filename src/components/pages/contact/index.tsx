    ...
    >
      <div className="contactNav w-full flex items-center justify-between">
        <div>
          ...
          {activeStep !== 0 && activeStep !== 2 && (
            <div
              className={`${styles.arrowMain} border px-2 py-5 rounded-full cursor-pointer`}
              onClick={handleBack}
            >
        ...
        <Link href={"/"}>
          <div
            className={`${styles.arrowMain} border px-3 py-5 rounded-full cursor-pointer`}
          >
            <div className={`${styles.arrowWrapper}`}>
              <span className={`${styles.arrowSpan}`}>
                <div
      ...
      {activeStep !== 2 && (
        <div className="absolute top-28 lg:top-10 left-1/2 -translate-x-1/2 w-auto flex items-center justify-center">
