  ...
  return (
    <div className="md:h-[530px] h-[420px] relative md:py-24 py-20">
      <div className="text-center text-[#fff]" data-aos='fade-right'>
        <h2 className="md:text-[72px] text-[35px] leading-[60px] font-serif font-[600]">About FlashFit</h2>
     ...
     <div>
      <div className=" w-full overflow-hidden rounded-[24px] absolute top-[65%] lg:top-[80%] 3xl:top-[75%] 4xl:top-[65%] mx-auto" >
         <Image src={aboutPositioningBannerImg} alt="aboutPositioningBannerImg" className="w-full mx-auto md:block hidden"/>
         <Image src={AboutBannerImageForMobile} alt="aboutPositioningBannerImg" className="w-full mx-auto md:hidden block"/>
      </div>
     </div>
