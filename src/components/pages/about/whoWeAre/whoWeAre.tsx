  ...
  return (
    ...
    <div className="md:flex  gap-10 w-full">
     ...
     <div className="w-full">
       <p className="md:text-start text-justify md:text-[24px] text-[20px] font-[400] mt-3">At FlashFit, our mission is to revolutionize the automotive industry by providing unparalleled car care services infused with passion,
