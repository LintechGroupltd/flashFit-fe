  ...
  return (
    <div className="md:mt-36 mt-24 py-5">
      <div className="grid md:grid-cols-2 gap-[35px] ">
        <div className="bg-[#2A317F] h-[289px] md:flex justify-between rounded-[38px]">
          <div>
        ...
        <div className="bg-[#F5F5F7] md:h-[289px] h-[400px] rounded-[38px] ">
          <div className="p-8 ">
      ...
      <div>
        <div className="grid md:grid-cols-12 gap-[35px]  mt-[33px] w-full ">
          ...
          <div className="md:col-span-9 w-full h-full">
            <Image src={wheelImg} alt="wheelImg" className="w-full" />
          </div>

          <div className="bg-[#F5F5F7] md:col-span-3  w-full p-14   rounded-[38px]">
