...
import img1 from "../../../../public/assets/services/images/brakeHeroImg.png";
...
const BrakeService = () => {
  return (
    ...
    {/* <div> */}
      <ServicesTopSection title="Brake Service" subTitle="Discover Our Passion for Precision, Commitment to Quality, and Dedication to Your Vehicle's Performance" />
    {/* </div> */}
